...
class StatusBar extends DrawableObject {
    IMAGES = [
        'img/7_statusbars/1_statusbar/2_statusbar_health/green/0.webp',
        'img/7_statusbars/1_statusbar/2_statusbar_health/green/20.webp',
        'img/7_statusbars/1_statusbar/2_statusbar_health/green/40.webp',
        'img/7_statusbars/1_statusbar/2_statusbar_health/green/60.webp',
        'img/7_statusbars/1_statusbar/2_statusbar_health/green/80.webp',
        'img/7_statusbars/1_statusbar/2_statusbar_health/green/100.webp'
    ];
    ...
    resolveImageIndex() {
        if (this.percentage == 100) {
            return 5;
        } else if (this.percentage > (100 - 2*(100/6))) {
            return 4;
        } else if (this.percentage > (100 - 3*(100/6))) {
            return 3;
        } else if (this.percentage > (100 - 4*(100/6))) {
            return 2;
        } else if (this.percentage > (100 - 5*(100/6))) {
            return 1;
        } else if(this.percentage < (100/6)) {
            return 0;
        }
    }
}